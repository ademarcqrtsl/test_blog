...
* **Clinical Indicators:** We analyze Blood Pressure (BP) history. A patient with a "jagged" history of uncontrolled BP or a recent spike is prioritized differently than one who has been stable.
...
* **Demographics:** Age, gender, and the specific facility location are factored in to account for regional variations in health-seeking behavior.

### 2. Deep Dive: Training the Predictive Model
To turn this data into a prediction, we follow a rigorous machine learning pipeline. You can view the full implementation in our public [PoC Scoring Repository](https://github.com/simpledotorg/poc_scoring_partient_return).
...
* **Algorithm Selection:** We employ ensemble methods like **XGBoost** or **Random Forest**. These models are excellent at handling tabular clinical data and capturing non-linear relationships.
